...
class FollowToggleTest(TestCase):
    ...
    def test_get_follow_toggle_for_followee(self):
        ...
        user_followers_before = self.user.followers_count()
        followee_followers_before = self.followee.followers_count()
        response = self.client.get(self.url, follow=True)
        user_followers_after = self.user.followers_count()
        followee_followers_after = self.followee.followers_count()
