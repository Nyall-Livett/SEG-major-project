...
urlpatterns = [
    ...
    path('delete_meeting/<int:meeting_id>/<int:club_id>', views.DeleteMeeting.as_view(), name='delete_meeting'),
    ...
    path('complete_meeting/<slug:pk>/<int:club_id>', views.CompleteMeetingView.as_view(), name='complete_meeting'),
    path('edit_meeting/<slug:pk>/<int:club_id>', views.EditMeetingView.as_view(), name='edit_meeting'),
    path('book/', views.CreateBookView.as_view(), name='book'),
    path('clubs/', views.ClubListView.as_view(), name='club_list'),
    path('join_club/<int:club_id>', views.JoinRemoveClubView.as_view(), name='join_club'),
    ...
    path('change_club_details/<int:club_id>', views.ChangeClubDetails.as_view(), name='change_club_details'),
